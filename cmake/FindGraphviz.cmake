...
set(GRAPHVIZ_ROOT "" CACHE PATH "Root of GRAPHVIZ distribution.")
find_path(GRAPHVIZ_INCLUDE_DIR NAMES graphviz/gvc.h PATHS ${GRAPHVIZ_ROOT}/include)
find_library(GRAPHVIZ_cdt_LIBRARY NAMES cdt PATHS ${GRAPHVIZ_ROOT}/lib)
find_library(GRAPHVIZ_gvc_LIBRARY NAMES gvc HINTS ${GRAPHVIZ_ROOT} ENV GRAPHVIZ_DIR PATH_SUFFIXES lib)
find_library(GRAPHVIZ_graph_LIBRARY NAMES graph cgraph HINTS ${GRAPHVIZ_ROOT} ENV GRAPHVIZ_DIR PATH_SUFFIXES lib)
find_library(GRAPHVIZ_pathplan_LIBRARY NAMES pathplan HINTS ${GRAPHVIZ_ROOT} ENV GRAPHVIZ_DIR PATH_SUFFIXES lib)
